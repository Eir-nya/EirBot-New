...
public struct RandomMethods {
	public static string GetRollResult(int sides, int number) {
		...
		for (var i = 0; i < number; i++) {
			var num = Random.Shared.Next(1, sides + 1);
			total += num;
	...
	public async static Task PostResult(InteractionContext context, string resultString) {
...
public partial class GenericCommands : AppCommandGroupBase {
	...
	public async static Task Flip(InteractionContext context) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
		var flip = Random.Shared.NextSingle() < 0.5f;
...
public partial class RollCommands : AppCommandGroupBase {
	...
	public async static Task D4(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task D6(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task Dice(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
		await RandomMethods.PostResult(context, RandomMethods.GetRollResult(6, number));
	}

	[SlashCommand("D8", "Roll one or more D8s.", true, false)]
	public async static Task D8(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task D10(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task D20(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task D100(InteractionContext context, [Option("number", "Amount of dice to roll.", false), MinimumValue(1), MaximumValue(20)] int number = 1) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
	...
	public async static Task Fate(InteractionContext context, [Option("modifier", "Modifier to add to roll result."), MinimumValue(-20), MaximumValue(20)] int modifier = 0) {
		await context.CreateResponseAsync(InteractionResponseType.DeferredChannelMessageWithSource);
		var result = "Fate :game_die: **__";
