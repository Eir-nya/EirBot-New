...
namespace EirBot_New.AppCommands {
	...
	public partial class ContextMenuCommands : AppCommandGroupBase {
		...
		public async static Task PetPet(ContextMenuContext context) {
	...
	public partial class FunCommands : AppCommandGroupBase {
		...
		public async static Task PetPet(InteractionContext context, [Option("target", "User to pet.")] DiscordUser target) {
			await PetPetCommand.DoPetPet(context, target.AvatarUrl);
		}

		[SlashCommand("Petpet", "Pets an image.", true, false)]
		public async static Task PetPet(InteractionContext context, [Option("url", "Url of image to pet.")] string url) {
...
namespace EirBot_New.Events {
	public class PetPetCommand {
		...
		public async static Task DoPetPet(BaseContext context, string url) {
